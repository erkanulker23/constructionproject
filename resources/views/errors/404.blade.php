...
<section class="top-space-margin3 404">
    <div class="container">
        <div class="row align-items-center justify-content-center h-100">
            <div class="col-12 col-xl-6 col-lg-7 col-md-9 text-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <h4 class="text-dark-gray fw-600 sm-fs-22 mb-10px ls-minus-1px">Aradığınız Sayfa Bulunamadı!</h4>
                <p class="mb-30px lh-28 sm-mb-30px w-55 md-w-80 sm-w-95 mx-auto">Aradığınız sayfa mevcut değil veya kaldırılmış olabilir. </p>
